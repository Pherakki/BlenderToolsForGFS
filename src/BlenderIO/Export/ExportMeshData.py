...
def export_mesh_data(gfs, armature, errorlog, log_missing_weights, recalculate_tangents, throw_missing_weight_errors, too_many_vertices_policy, multiple_materials_policy, missing_uv_maps_policy, triangulate_mesh_policy):
    ...
    for bpy_mesh_object in meshes:
        ...
        gfs_meshes = []
        gfs_meshes.append(create_mesh(gfs, bpy_mesh_object, armature, node_id, material_names, material_index, errorlog, log_missing_weights, recalculate_tangents, throw_missing_weight_errors, missing_uv_maps_policy, triangulate_mesh_policy))
        ...
        for bpy_submesh_object in attached_meshes:
            ...
            gfs_meshes.append(create_mesh(gfs, bpy_submesh_object, armature, node_id, material_names, material_index, errorlog, log_missing_weights, recalculate_tangents, throw_missing_weight_errors, missing_uv_maps_policy, triangulate_mesh_policy))
        ...
        for bpy_mesh_object in sorted(new_meshes):
            gfs_meshes.append(create_mesh(gfs, bpy_submesh_object, armature, node_id, material_names, 0, errorlog, log_missing_weights, recalculate_tangents, throw_missing_weight_errors, missing_uv_maps_policy, triangulate_mesh_policy))
...
def create_mesh(gfs, bpy_mesh_object, armature, node_id, export_materials, material_index, errorlog, log_missing_weights, recalculate_tangents, throw_missing_weight_errors, missing_uv_maps_policy, triangulate_mesh_policy):
