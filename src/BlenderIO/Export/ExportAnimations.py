...
def export_gap_props(gfs, bpy_armature_object, ap_props, keep_unused_anims, errorlog):
    if get_preferences().developer_mode and get_preferences().wip_animation_import:
        export_gap_from_props(gfs, bpy_armature_object, ap_props, keep_unused_anims, errorlog)
        return
...
def export_gap_from_props(gfs, bpy_armature_object, ap_props, keep_unused_anims, errorlog):
    mprops = bpy_armature_object.data.GFSTOOLS_ModelProperties
